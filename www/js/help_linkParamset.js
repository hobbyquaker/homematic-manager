var help_linkParamset = {
    "ACTION_TYPE": {
        ...
        "params": {
            ...
            "TOGGLE_INVERS_TO_COUNTER": "springe im Profil abhängig vom letzten Bit des Tastendruckzählers (0=Ein, 1=Aus)",
            ...
            "TOGGLEDIM_INVERS_TO_COUNTER": "um DIM_STEP invers zur Richtung des letzten Bits vom Tastendruckzähler dimmen (0=hoch, 1=runter). Verhalten ist dabei wie bei UPDIM oder DOWNDIM."
        }
    }
}